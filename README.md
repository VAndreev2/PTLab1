...
Программа работает с чтением файла, который хранит информацию о студентах (имя, баллы). В соответствии с этими баллами программа рассчитывает средний балл и список студентов, которые попадают в последний квартиль.
